...
function EmployeeList ({employees, onSwitchPromotion, onDelete}) {
    const employeesItems = employees.map((employee, id) => {
        return <EmployeeItem onDelete={()=>{ onDelete(id) }} onSwitchPromotion={ () => { onSwitchPromotion(id)} } key={id} {...employee}/> 
    });
